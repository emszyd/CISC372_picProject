...
void convolute(Image* srcImage,Image* destImage,Matrix algorithm){
    int row, pix, bit;
     //pix and bit are private so each thread has its own copy of those loop vairables
    #pragma omp parallel for private(pix, bit) //splits the row loop across multiple threads
